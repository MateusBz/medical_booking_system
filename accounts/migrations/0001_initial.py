# Generated by Django 3.0.7 on 2020-06-07 05:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Mężczyzna'), ('W', 'Kobieta'), ('NN', 'Odmowa')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speciality', models.ManyToManyField(to='accounts.DoctorSpeciality')),
            ],
        ),
    ]
